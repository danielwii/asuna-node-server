...
export class CacheTTL {
  ...
  static LONG_1 = configLoader.loadNumericConfig('CACHE_LONG_1_TTL', 3600_000); // 60min
  static LONG_24 = configLoader.loadNumericConfig('CACHE_LONG_24_TTL', 24 * 3600_000); // 24hour
  static WEEK = configLoader.loadNumericConfig('CACHE_WEEK_TTL', 7 * 24 * 3600_000); // 1week
}
